...
const absoluteUrl = path => `https://hang.coffee${path}`;
const seoImageURL = file => `https://hang.coffee/images/${file}`;
...
const getMetaTags = ({
  ...
  const metaTags = [
    ...
    { name: 'twitter:site', content: '@letshangerang' },
    { name: 'twitter:title', content: `${title} | Hangerang | Let's Get Together.` },
    { name: 'twitter:description', content: description },
    { name: 'twitter:creator', content: twitter || '@letshangerang' },
    { name: 'og:title', content: `${title} | Hangerang | Let's Get Together.` },
    { name: 'og:type', content: contentType },
    { name: 'og:url', content: url },
    { name: 'og:description', content: description },
    { name: 'og:site_name', content: `Hangerang | Let's Get Together.`  },
